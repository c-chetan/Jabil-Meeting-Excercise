...
namespace MeetingAppDataLayer.Migrations
{
    ...
    [Migration("20200129044450_CreatedAttendeeMeetingTableCorreced")]
    partial class CreatedAttendeeMeetingTableCorreced
    {
            ...
            modelBuilder.Entity("MeetingAppDataLayer.Models.Attendee", b =>
                {
                    ...
                    b.Property<int?>("FK_MeetingAttendeeId");

                    b.Property<int?>("FK_UserAttendeeId");

                    b.Property<bool>("IsMeetingOwner");

                    b.HasKey("AttendeeId");

                    b.HasIndex("FK_MeetingAttendeeId");

                    b.HasIndex("FK_UserAttendeeId");
            ...
            modelBuilder.Entity("MeetingAppDataLayer.Models.Attendee", b =>
                {
                    b.HasOne("MeetingAppDataLayer.Models.Meeting", "Meeting")
                        .WithMany("Attendees")
                        .HasForeignKey("FK_MeetingAttendeeId");

                    b.HasOne("MeetingAppDataLayer.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("FK_UserAttendeeId");
                });
